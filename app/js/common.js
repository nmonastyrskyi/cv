$(function() {
  ...
  var lang_en = {"about.name": "Nikita Monastyrskiy",
  "about.vocaction": "Fron-end Developer",
  "education": "Education",
  "basic.university1": "Kharkiv National  University of Arts",
  "basic.rank1": "Bachelor (Theatre department)",
  "basic.university2": "People's Ukranian Academy",
  "basic.rank2": "Bachelor (Buisness Administration department)",
  ...
  "skills.mobile": "Markup of emails;",
  ...
  "expirience.non-comercial" : "Non-comercial expirience",
  "expirience.comercial" : "Comercial expirience",
  ...
  "intelectual" : "I ntelectual games",
  "bike": " Bike"};
  var lang_ru = {
  "about.name": "Никита Монастырский",
  "about.vocaction": "Fron-end Developer",
  "education": "Образование",
  "basic.university1": "ХНУИ им. Котляревского",
  "basic.rank1": "Бакалавр (Театральный факультет)",
  "basic.university2": "ХГУ \"НУА\" ",
  "basic.rank2": "Бакалавр (Экономика предприятия)",
  "course.name": "Harvard CS50 online-course",
  ...
  "skills.mobile": "Mobile Friendly;",
  "skills.mobile": "Верстка электронных писем",
  ...
  "skills.programming": "Програмированние",
  "skills.js": "работа с массивами, строками, объектами, событиями, датами, таймерами, объектом Event, замыкания, DOM, метрики, регулярные выражения, функции и переменные ES6;",
  ...
  "expirience.non-comercial" : "Некомерческий опыт",
  "expirience.comercial" : "Комерческий опыт",
  ...
  "about.vocaction": "Fron-end Developer",
  "education": "Освiта",
  "basic.university1": "ХНУМ iм. Котляревського",
  "basic.rank1": "Бакалавр (Театральный факультет)",
  "basic.university2": "ХГУ \"НУА\" ",
  "basic.rank2": "Бакалавр (Экономiка пiдприємства)",
  "course.name": "Harvard CS50 online-course",
  ...
  "skills.mobile": "Mobile Friendly;",
  "skills.mobile": "Верстка электронних писем",
  ...
  "skills.js": "робота з масивами, рядками, об'єктами, подіями, датами, таймерами, об'єктом Евент; замикання DOM, метрики, регулярні вирази, функції та змінні ES6;",
  ...
  "skills.sql": "SQL",
  "skills.c" : "C: робота зі змінними, функціями, аргументами командного рядка, покажчиками, пов'язані списки, хеш-таблиці, дерева, розподіл динамічної пам'яті.",
  "expirience.name" : "Досвід",
  "expirience.non-comercial" : "Некомерційні досвід ",
  "expirience.comercial" : "Комерційні досвід ",
  "expirience.turnkey" : "Сайт під ключ",
  "interests": "Інтересы",
  "hobbies": " Інтересы и Хоббі",
  "books" : " Книги",
  "travel": " Подорожі",
